...
func (d *Dogstatsd) NewGauge(name string) *Gauge { _ = "STUB: not implemented"; return nil }
...
func (d *Dogstatsd) tagValues(labelValues []string) string { _ = "STUB: not implemented"; return "" }

type observeFunc func(name string, lvs lv.LabelValues, value float64)

func sampleObservations(obs observeFunc, sampleRate float64) observeFunc {
	_ = "STUB: not implemented"
	return *new(observeFunc)
}
